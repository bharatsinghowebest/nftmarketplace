...
export const accountFromJSON = (account: any): NFTAccount => {
  return {
...
export const userFromJSON = (user: any): NFTUser => {
  return {
    username: user.username
  }
}

export const assetBundleFromJSON = (asset_bundle: any): NFTAssetBundle => {

  const fromJSON: NFTAssetBundle = {
...
export const assetContractFromJSON = (asset_contract: any): NFTAssetContract => {
  return {
    ...
    nftBuyerFeeBasisPoints: +asset_contract.nft_buyer_fee_basis_points,
    nftSellerFeeBasisPoints: +asset_contract.nft_seller_fee_basis_points,
...
export const collectionFromJSON = (collection: any): NFTCollection => {
  ...
  return {
    ...
    nftBuyerFeeBasisPoints: +collection.nft_buyer_fee_basis_points,
    nftSellerFeeBasisPoints: +collection.nft_seller_fee_basis_points,
    ...
    traitStats: collection.traits as NFTTraitStats,
    externalLink: collection.external_url,
    wikiLink: collection.wiki_url,
  }
}

export const tokenFromJSON = (token: any): NFTFungibleToken => {

  const fromJSON: NFTFungibleToken = {
    name: token.name,
    symbol: token.symbol,
...
async function canSettleOrder(client: NFTPort, order: Order, matchingOrder: Order): Promise<boolean> {
