...
export class NFTAPI {
  ...
  public async getAssets(
      query: NFTAssetQuery = {},
      page = 1
    ): Promise<{assets: NFTAsset[]; estimatedCount: number}> {
  ...
  public async getPaymentTokens(
      query: NFTFungibleTokenQuery = {},
      page = 1,
      retries = 1
    ): Promise<{tokens: NFTFungibleToken[]}> {
  ...
  public async getBundles(
      query: NFTAssetBundleQuery = {},
      page = 1
    ): Promise<{bundles: NFTAssetBundle[]; estimatedCount: number}> {
