...
export const MAINNET_PROVIDER_URL = 'https://api.nft.io/jsonrpc/v1/'
export const RINKEBY_PROVIDER_URL = 'https://rinkeby-api.nft.io/jsonrpc/v1/'
...
export const API_BASE_MAINNET = 'https://api.nft.io'
export const API_BASE_RINKEBY = 'https://rinkeby-api.nft.io'
export const SITE_HOST_MAINNET = 'https://nft.io'
export const SITE_HOST_RINKEBY = 'https://rinkeby.nft.io'
