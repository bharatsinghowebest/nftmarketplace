...
import { FeeMethod, NFTAPIConfig, OrderSide, UnhashedOrder, Order, UnsignedOrder, PartialReadonlyContractAbi, EventType, EventData, NFTAsset, WyvernSchemaName, NFTFungibleToken, WyvernAsset, ComputedFees, Asset } from './types';
import { BigNumber } from 'bignumber.js';
import { EventSubscription } from 'fbemitter';
export declare class NFTPort {
    web3: Web3;
    web3ReadOnly: Web3;
