...
import { NFTAPIConfig, NFTAsset, NFTAssetBundle, NFTAssetBundleQuery, NFTAssetQuery, NFTFungibleToken, NFTFungibleTokenQuery, Order, OrderJSON, OrderQuery } from './types';
export declare class NFTAPI {
     ...
     */
    constructor(config: NFTAPIConfig, logger?: (arg: string) => void);
    /**
    ...
    }, retries?: number): Promise<NFTAsset>;
    /**
     ...
     */
    getAssets(query?: NFTAssetQuery, page?: number): Promise<{
        assets: NFTAsset[];
     ...
     * @param retries Number of times to retry if the service is unavailable for any reason
     */
    getPaymentTokens(query?: NFTFungibleTokenQuery, page?: number, retries?: number): Promise<{
        tokens: NFTFungibleToken[];
    }>;
    /**
     ...
     */
    getBundles(query?: NFTAssetBundleQuery, page?: number): Promise<{
        bundles: NFTAssetBundle[];
        estimatedCount: number;
    }>;
    /**
