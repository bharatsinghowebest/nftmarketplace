...
function encodeAtomicizedCalldata(atomicizer, schemas, assets, address, side) {
    ...
    try {
        ...
        throw new Error("Failed to construct your order: likely something strange about this type of item. NFT has been notified. Please contact us in Discord! Original error: " + error);
    }
}
