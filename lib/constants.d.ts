...
export declare const MAINNET_PROVIDER_URL = "https://api.nft.io/jsonrpc/v1/";
export declare const RINKEBY_PROVIDER_URL = "https://rinkeby-api.nft.io/jsonrpc/v1/";
...
export declare const API_BASE_MAINNET = "https://api.nft.io";
export declare const API_BASE_RINKEBY = "https://rinkeby-api.nft.io";
export declare const SITE_HOST_MAINNET = "https://nft.io";
export declare const SITE_HOST_RINKEBY = "https://rinkeby.nft.io";
