...
var NFTAPI = /** @class */ (function () {
    /**
     * Create an instance of the NFT API
     * @param config NFTAPIConfig for setting up the API, including an optional API key, network name, and base URL
     * @param logger Optional function for logging debug strings before and after requests are made
     */
    function NFTAPI(config, logger) {
        /**
     ...
     */
    NFTAPI.prototype.postOrder = function (order, retries) {
     ...
     */
    NFTAPI.prototype.postAssetWhitelist = function (tokenAddress, tokenId, email) {
        return __awaiter(this, void 0, void 0, function () {
            var json;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    NFTAPI.prototype.getOrder = function (query) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    NFTAPI.prototype.getOrders = function (query, page) {
     ...
     * @param retries Number of times to retry if the service is unavailable for any reason
     */
    NFTAPI.prototype.getAsset = function (_a, retries) {
     ...
     * @param query Query to use for getting orders. A subset of parameters on the `NFTAssetJSON` type is supported
     * @param page Page number, defaults to 1. Can be overridden by
     * `limit` and `offset` attributes from NFTAssetQuery
     */
    NFTAPI.prototype.getAssets = function (query, page) {
        if (query === void 0) { query = {}; }
        if (page === void 0) { page = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var json;
     ...
     * @param query Query to use for getting orders. A subset of parameters on the `NFTAssetJSON` type is supported
     * @param page Page number, defaults to 1. Can be overridden by
     * `limit` and `offset` attributes from NFTFungibleTokenQuery
     * @param retries Number of times to retry if the service is unavailable for any reason
     */
    NFTAPI.prototype.getPaymentTokens = function (query, page, retries) {
        if (query === void 0) { query = {}; }
        if (page === void 0) { page = 1; }
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    NFTAPI.prototype.getBundle = function (_a) {
        var slug = _a.slug;
        return __awaiter(this, void 0, void 0, function () {
            var json;
            return __generator(this, function (_b) {
     ...
     * @param query Query to use for getting orders. A subset of parameters on the `NFTAssetBundleJSON` type is supported
     * @param page Page number, defaults to 1. Can be overridden by
     * `limit` and `offset` attributes from NFTAssetBundleQuery
     */
    NFTAPI.prototype.getBundles = function (query, page) {
        if (query === void 0) { query = {}; }
        if (page === void 0) { page = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var json;
     ...
     */
    NFTAPI.prototype.get = function (apiPath, query) {
        if (query === void 0) { query = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var qs, url, response;
            return __generator(this, function (_a) {
     ...
     */
    NFTAPI.prototype.post = function (apiPath, body, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     *  a body, it won't be stringified.
     */
    NFTAPI.prototype.put = function (apiPath, body, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    NFTAPI.prototype._fetch = function (apiPath, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    NFTAPI.prototype._handleApiResponse = function (response) {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 4:
                        ...
                        switch (response.status) {
                            ...
                            case 404:
                                ...
                                break;
                            case 500:
                                errorMessage = "Internal server error. NFT has been alerted, but if the problem persists please contact us via Discord: https://discord.gg/ga8EJbv - full message was " + JSON.stringify(result);
                                break;
                            case 503:
