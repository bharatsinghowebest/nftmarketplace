...
import { Asset, AssetEvent, ECSignature, NFTAccount, NFTAsset, NFTAssetBundle, NFTAssetContract, NFTCollection, NFTFungibleToken, NFTUser, Order, OrderJSON, Transaction, UnhashedOrder, UnsignedOrder, Web3Callback, WyvernAsset, WyvernBundle, WyvernFTAsset, WyvernNFTAsset } from './types';
...
export declare const assetFromJSON: (asset: any) => NFTAsset;
...
export declare const accountFromJSON: (account: any) => NFTAccount;
export declare const userFromJSON: (user: any) => NFTUser;
export declare const assetBundleFromJSON: (asset_bundle: any) => NFTAssetBundle;
export declare const assetContractFromJSON: (asset_contract: any) => NFTAssetContract;
export declare const collectionFromJSON: (collection: any) => NFTCollection;
export declare const tokenFromJSON: (token: any) => NFTFungibleToken;
...
/**
 * Wrapper function for getting generic Wyvern assets from NFT assets
