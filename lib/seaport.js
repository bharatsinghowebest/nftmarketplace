...
var NFTPort = /** @class */ (function () {
    /**
     * Your very own seaport.
     * Create a new instance of NFTJS.
     ...
     *  information
     */
    function NFTPort(provider, apiConfig, logger) {
        ...
        this.api = new api_1.NFTAPI(apiConfig);
     ...
     */
    NFTPort.prototype.addListener = function (event, listener, once) {
     ...
     */
    NFTPort.prototype.removeListener = function (subscription) {
        subscription.remove();
    };
    /**
     ...
     */
    NFTPort.prototype.removeAllListeners = function (event) {
     ...
     */
    NFTPort.prototype.wrapAssets = function (_a) {
     ...
     * @param accountAddress Address of the user's wallet
     */
    NFTPort.prototype.unwrapAssets = function (_a) {
     ...
     */
    NFTPort.prototype.liquidateAssets = function (_a) {
     ...
     * @param accountAddress Address of the user's wallet
     */
    NFTPort.prototype.purchaseAssets = function (_a) {
     ...
     * @param contractAddress Address of the corresponding NFT core contract for these NFTs.
     */
    NFTPort.prototype.getQuoteFromUniswap = function (_a) {
     ...
     */
    NFTPort.prototype.wrapEth = function (_a) {
     ...
     */
    NFTPort.prototype.unwrapWeth = function (_a) {
        var amountInEth = _a.amountInEth, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var token, amount, gasPrice, txHash;
            var _this = this;
     ...
     */
    NFTPort.prototype.createBundleBuyOrder = function (_a) {
     ...
     * @param referrerAddress The optional address that referred the order
     */
    NFTPort.prototype.createBuyOrder = function (_a) {
     ...
     */
    NFTPort.prototype.createSellOrder = function (_a) {
     ...
     * Items will mint to users' wallets only when they buy them. See https://docs.nft.io/docs/nft-initial-item-sale-tutorial for more info.
     * If the user hasn't approved access to the token yet, this will emit `ApproveAllAssets` (or `ApproveAsset` if the contract doesn't support approve-all) before asking for approval.
     * @param param0 __namedParameters Object
     ...
     */
    NFTPort.prototype.createFactorySellOrders = function (_a) {
     ...
     */
    NFTPort.prototype.createBundleSellOrder = function (_a) {
     ...
     */
    NFTPort.prototype.fulfillOrder = function (_a) {
     ...
     */
    NFTPort.prototype.cancelOrder = function (_a) {
     ...
     */
    NFTPort.prototype.approveSemiOrNonFungibleToken = function (_a) {
     ...
     */
    NFTPort.prototype.approveFungibleToken = function (_a) {
     ...
     */
    NFTPort.prototype.unapproveFungibleToken = function (_a) {
     ...
     */
    NFTPort.prototype.getCurrentPrice = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var currentPrice;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @param referrerAddress The optional address that referred the order
     */
    NFTPort.prototype.isOrderFulfillable = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress, referrerAddress = _a.referrerAddress;
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    NFTPort.prototype.isAssetTransferrable = function (_a, retries) {
     ...
     * @returns Transaction hash
     */
    NFTPort.prototype.transfer = function (_a) {
     ...
     * @returns Transaction hash
     */
    NFTPort.prototype.transferAll = function (_a) {
     ...
     *    officially supported and shown on nft.io
     */
    NFTPort.prototype.getFungibleTokens = function (_a) {
     ...
     */
    NFTPort.prototype.getAssetBalance = function (_a, retries) {
     ...
     */
    NFTPort.prototype.getTokenBalance = function (_a, retries) {
     ...
     * @param extraBountyBasisPoints The basis points to add for the bounty. Will throw if it exceeds the assets' contract's NFT fee.
     */
    NFTPort.prototype.computeFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var nftBuyerFeeBasisPoints, nftSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, result, error_9, sellerBountyBasisPoints, bountyTooLarge, errorMessage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        nftBuyerFeeBasisPoints = constants_1.DEFAULT_BUYER_FEE_BASIS_POINTS;
                        nftSellerFeeBasisPoints = constants_1.DEFAULT_SELLER_FEE_BASIS_POINTS;
                        ...
                        if (asset) {
                            nftBuyerFeeBasisPoints = +asset.collection.nftBuyerFeeBasisPoints;
                            nftSellerFeeBasisPoints = +asset.collection.nftSellerFeeBasisPoints;
                            ...
                            maxTotalBountyBPS = nftSellerFeeBasisPoints;
                        }
                    ...
                    case 4:
                        ...
                        if (sellerBountyBasisPoints > 0 && bountyTooLarge) {
                            ...
                            if (maxTotalBountyBPS >= constants_1.OPENSEA_SELLER_BOUNTY_BASIS_POINTS) {
                                errorMessage += " Remember that NFT will add " + constants_1.OPENSEA_SELLER_BOUNTY_BASIS_POINTS / 100 + "% for referrers with NFT accounts!";
                            }
                            throw new Error(errorMessage);
                        }
                        // Remove fees for private orders
                        if (isPrivate) {
                            nftBuyerFeeBasisPoints = 0;
                            nftSellerFeeBasisPoints = 0;
                            devBuyerFeeBasisPoints = 0;
                            devSellerFeeBasisPoints = 0;
                            sellerBountyBasisPoints = 0;
                        }
                        return [2 /*return*/, {
                                totalBuyerFeeBasisPoints: nftBuyerFeeBasisPoints + devBuyerFeeBasisPoints,
                                totalSellerFeeBasisPoints: nftSellerFeeBasisPoints + devSellerFeeBasisPoints,
                                nftBuyerFeeBasisPoints: nftBuyerFeeBasisPoints,
                                nftSellerFeeBasisPoints: nftSellerFeeBasisPoints,
    ...
    /**
     * Validate and post an order to the NFT orderbook.
     ...
     */
    NFTPort.prototype.validateAndPostOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    NFTPort.prototype._computeGasPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    NFTPort.prototype._correctGasAmount = function (estimation) {
     ...
     */
    NFTPort.prototype._estimateGasForMatch = function (_a, retries) {
     ...
     */
    NFTPort.prototype._estimateGasForTransfer = function (_a) {
        var assets = _a.assets, fromAddress = _a.fromAddress, toAddress = _a.toAddress, _b = _a.schemaName, schemaName = _b === void 0 ? types_1.WyvernSchemaName.ERC721 : _b;
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    NFTPort.prototype._getProxy = function (accountAddress, retries) {
     ...
     * @param accountAddress The user's wallet address
     */
    NFTPort.prototype._initializeProxy = function (accountAddress) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    NFTPort.prototype._getApprovedTokenCount = function (_a) {
        var accountAddress = _a.accountAddress, tokenAddress = _a.tokenAddress, proxyAddress = _a.proxyAddress;
        return __awaiter(this, void 0, void 0, function () {
    ...
    NFTPort.prototype._makeBuyOrder = function (_a) {
    ...
    NFTPort.prototype._makeSellOrder = function (_a) {
    ...
    NFTPort.prototype._getStaticCallTargetAndExtraData = function (_a) {
    ...
    NFTPort.prototype._makeBundleBuyOrder = function (_a) {
    ...
    NFTPort.prototype._makeBundleSellOrder = function (_a) {
    ...
    NFTPort.prototype._makeMatchingOrder = function (_a) {
        var _this = this;
     ...
     */
    NFTPort.prototype._validateMatch = function (_a, retries) {
    ...
    NFTPort.prototype._createEmailWhitelistEntry = function (_a) {
    ...
    // Throws
    NFTPort.prototype._sellOrderValidationAndApprovals = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    NFTPort.prototype._approveOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    NFTPort.prototype._validateOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var isValid;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    NFTPort.prototype._approveAll = function (_a) {
    ...
    // Throws
    NFTPort.prototype._buyOrderValidationAndApprovals = function (_a) {
     ...
     */
    NFTPort.prototype._ownsAssetOnChain = function (_a) {
    ...
    NFTPort.prototype._getBuyFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, sellOrder) {
    ...
    NFTPort.prototype._getSellFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBasisPoints) {
     ...
     */
    NFTPort.prototype._validateFees = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints) {
     ...
     */
    NFTPort.prototype._getTimeParameters = function (expirationTimestamp, listingTimestamp, waitingForBestCounterOrder) {
     ...
     */
    NFTPort.prototype._getPriceParameters = function (orderSide, tokenAddress, expirationTime, startAmount, endAmount, waitingForBestCounterOrder, englishAuctionReservePrice) {
        if (waitingForBestCounterOrder === void 0) { waitingForBestCounterOrder = false; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    NFTPort.prototype._getMetadata = function (order, referrerAddress) {
    ...
    NFTPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_1.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 11:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The NFT devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"" + error_13.message.substr(0, debugging_1.MAX_ERROR_LENGTH) + "...\"");
                    case 12:
    ...
    NFTPort.prototype._getRequiredAmountForTakingSellOrder = function (sell) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    NFTPort.prototype._authorizeOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    NFTPort.prototype._getSchema = function (schemaName) {
    ...
    NFTPort.prototype._dispatch = function (event, data) {
     ...
     */
    NFTPort.prototype._getClientsForRead = function (retries) {
        if (retries === void 0) { retries = 1; }
        if (retries > 0) {
    ...
    NFTPort.prototype._confirmTransaction = function (transactionHash, event, description, testForSuccess) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    NFTPort.prototype._pollCallbackForConfirmation = function (event, description, testForSuccess) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
